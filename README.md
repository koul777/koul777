...
공공기관 인사조직 현장에서 발견한 문제를 **AI, 데이터 분석, 자동화**로 해결합니다.
새로운 기술을 도입하는 데서 멈추지 않고, 실제 일하는 방식의 변화로 이어지는 프로그램을 만들고 있습니다.
...
![ChatGPT](https://img.shields.io/badge/Generative_AI-412991?style=flat-square&logo=openai&logoColor=white)
